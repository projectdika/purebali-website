<x-app-layout>
<main class="w-full overflow-x-hidden min-h-screen bg-[#F3E9DC]">
...
<div class="absolute inset-0 flex flex-col justify-end p-8 md:p-16 lg:p-20 z:10 gap-6">
    ...
    <div class="bg-[#C37F43] text-white px-4 py-2 rounded-md w-fit flex gap-2 items-center">
